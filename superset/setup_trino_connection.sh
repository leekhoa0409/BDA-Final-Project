...
echo ""
echo "Available Gold tables to explore in SQL Lab:"
echo "  - delta.default.gold_weather_daily_stats"
echo "  - delta.default.gold_weather_monthly_stats"
echo "  - delta.default.gold_weather_city_summary"
